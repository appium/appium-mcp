...
import createSessionGroup from './session/create-session-group.js';
import deleteSession from './session/delete-session.js';
import deleteSessionGroup from './session/delete-session-group.js';
import listSessions from './session/list-sessions.js';
import listSessionGroups from './session/list-session-groups.js';
import selectSession from './session/select-session.js';
import selectSessionGroup from './session/select-session-group.js';
...
export default function registerTools(server: FastMCP): void {
  ...
  createSessionGroup(server);
  listSessions(server);
  listSessionGroups(server);
  selectSession(server);
  selectSessionGroup(server);
  deleteSession(server);
  deleteSessionGroup(server);
